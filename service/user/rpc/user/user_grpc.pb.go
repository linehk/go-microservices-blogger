...
func (c *userServiceClient) Get(ctx context.Context, in *GetReq, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
func (UnimplementedUserServiceServer) Get(context.Context, *GetReq) (*User, error) {
